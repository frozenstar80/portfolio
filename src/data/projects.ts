...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "A production Android app for managing business records digitally, where I contributed to growth from 200K+ to 1M+ downloads, built most of the XML-based UI, integrated REST APIs with coroutines, and helped migrate the app to MVVM architecture.",
    clientName: "RecordBook",
    projectType: "Client Project",
    role: "Android App Developer",
    startDate: "2025",
    endDate: "2025",
    status: "Live",
    technologies: ["Android", "Kotlin", "XML UI", "Coroutines", "REST APIs", "MVVM", "Data Structures"],
    features: ["Business registers", "Team collaboration", "PDF and report generation", "28 column types", "Automatic backup", "Scalable Android UI"],
    ...
    caseStudy: {
      overview:
        "RecordBook is a live Android business data management app that helps teams digitize registers, manage records, and generate reports. I worked on product improvements during its growth from 200K+ to 1M+ downloads.",
      clientContext:
        "Client Android project for RecordBook, focused on practical business usage, data security, team collaboration, Play Store-ready delivery, and scalable app growth.",
      problem:
      ...
      handled: [
        "Developed most of the application UI using Android XML layouts.",
        "Integrated REST APIs using Kotlin coroutines for smoother asynchronous app behavior.",
        "Used data structures and algorithmic logic to support additional product functionality.",
        "Helped migrate the codebase toward MVVM architecture for cleaner separation of concerns.",
        "Contributed to product improvements while the app scaled from 200K+ to 1M+ downloads.",
      ],
      techStack: ["Android", "Kotlin", "XML layouts", "Coroutines", "REST APIs", "MVVM", "Data Structures"],
      mobileFeatures: ["Register management", "Team member access", "PDF templates", "Customer register", "Reports dashboard", "XML-based Android UI"],
      backendAndApi: ["REST API integration with coroutines", "Firebase-backed records", "Backup/restore workflows", "Team access data handling"],
      deploymentSupport: ["Play Store release support", "Production QA", "Post-launch support"],
      outcome: ["Live on Google Play", "Scaled from 200K+ to 1M+ downloads", "Business data workflows digitized", "MVVM migration supported"],
    },
  },
  {
    id: "quickdoor",
